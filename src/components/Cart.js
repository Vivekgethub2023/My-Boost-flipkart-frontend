    ...
    async function fetchCartAndProducts() {
      ...
      try {
        ...
        const cartRes = await fetch(
          "https://flipkart-backend-prxu.onrender.com/carts"
        );
        const cartData = await cartRes.json();
        if (!cartData.success) throw new Error("Failed to fetch carts");
        //find all carts for the current user and mergee their items
        ...
        const prodRes = await fetch(
          "https://flipkart-backend-prxu.onrender.com/products"
        );
        const productsResponse = await prodRes.json();
        //robustly flatten all nested products array
        let allProducts = [];
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    ...
                    {item.discountPercentage && (
                      <span className="texxt-green-600 font-semibold text-sm">
