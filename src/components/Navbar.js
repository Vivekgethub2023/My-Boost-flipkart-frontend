...
const categories = [
  ...
  { name: "Fashion", icon: "👚", route: "/categoryfashion" },
  { name: "Electronics", icon: "💻", route: "/category/electronics" },
  { name: "Home & Furniture", icon: "🧳", route: "/category/home-furniture" },
  { name: "Appliances", icon: "🔌", route: "/category/appliances" },
  { name: "Flight Booking", icon: "✈", route: "/category/flight-booking" },
  {
    name: "Beauty, Toys & More",
    icon: "🧸",
    route: "/category/beauty-toys-more",
  },
  { name: "Two Wheelers", icon: "🏍", route: "/category/two-wheelers" },
];
...
export default function Navbar() {
  ...
  // Handlers to keep dropdown open when hovering over either buttons or useMenuTimeout
      ...
      <div className="flex items-center px-8 pt-2 pb-0 justify-between">
        ...
        <form className="flex-1 mx-8 relative" onSubmit={handleSearch}>
          <input
            ...
            className="w-full px-4 py-2 rounded-md border border-gray-200 text-base bg-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-200 pr-12"
            value={search}
        ...
        <div className="flex items-center gap-6">
          ...
          >
            <span className="flex items-center gap-1">
              ...
              <span className="text-blue-700">Vivek</span>
